...
from lib.logzero.colors import Fore as ForegroundColors
...
'''
 --------------------------------------------------------------------
logzero
Latest version on PyPi Build status for master branch Documentation
Status Updates Anaconda-Server Badge
