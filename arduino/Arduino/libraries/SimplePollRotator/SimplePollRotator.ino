...
// >>>! On arduino uno connect digital pins 1/2 to clk/dt encoder pins !<<<
// 1/20/2022 1409, works as expected
...
// >>>! wrong !>>> * A2 and A3 on Arduino UNO.
...
void setup()
{
  Serial.begin(115200);
  while (! Serial);
  Serial.println("SssimplePollRotator example for the RotaryEncoder library.");
} // setup()
